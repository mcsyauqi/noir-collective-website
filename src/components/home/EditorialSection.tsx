...
export default function EditorialSection() {
  ...
  return (
    <section ref={sectionRef} className="py-40 md:py-60 bg-noir-black text-pure-white">
      <div className="container-fluid">
        <div className="editorial-container grid md:grid-cols-2 gap-20 md:gap-32 items-center">
          {/* Image */}
          ...
          <div className="editorial-text">
            <p className="text-xs tracking-[0.2em] uppercase text-gold-accent mb-10">
              Filosofi Kami
            </p>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif mb-12 leading-tight">
              Lebih sedikit, tapi lebih baik. Potongan timeless untuk lemari pakaian modern.
            </h2>
            <p className="text-warm-gray mb-16 leading-relaxed text-base md:text-lg">
